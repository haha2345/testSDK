...
public class CBNOMyRecordActivity extends BaseMyCameraActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cbno_camera);
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showProgressDialog(CBNOMyRecordActivity.this, "请稍后");
...
//        filepath = SpUtils.getInstance(this).getString("videopath", null);
        ...
        if (videoFile.exists()) {
            ...
            if (!IsFileInUse(filepath)) {
                HttpRequest.build(CBNOMyRecordActivity.this, netConstant.getUploadNotarizeVideo())
...
//                                    bundle.putString("cbno_phone", cbno_phone);
...
//                                    bundle.putString("token",token);
                                    ...
                                    dismissProgressDialog();
                                    breaker(CBNOMyRecordActivity.this);
                                } else {
                                    Log.e("上传", main.getString("msg"));
                                    Log.e("上传", main.getString("code"));
                                    dismissProgressDialog();
                                    Toast.makeText(CBNOMyRecordActivity.this, main.getString("msg"), Toast.LENGTH_SHORT).show();
                                }
                            }
//                            }
                        })
            ...
            Toast.makeText(CBNOMyRecordActivity.this, "录制失败，请重新录制", Toast.LENGTH_SHORT).show();
