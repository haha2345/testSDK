...
//        }, 2000);//超时时间60秒
    ...
    //获得token
    private static void getToken(final Context mContext) {
...
//                "}";
    ...
    //添加合同信息，取得caseid
    private static void addContract(final Context mContext) {
//        Map<String, Object> reqMap = new HashMap();
...
//                                delayCloseTip();
    ...
    //四项实人接口
    //传递身份证号，人名，手机号
    private static void model0x12(final Context mContext, String value) {
